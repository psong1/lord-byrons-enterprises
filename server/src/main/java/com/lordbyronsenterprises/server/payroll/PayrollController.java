...
public class PayrollController {
    ...
    @PutMapping("/paychecks/{paycheckId}/disburse")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<PaycheckDto> disbursePaycheck(@PathVariable Long paycheckId) {
        return ResponseEntity.ok(payrollService.disbursePaycheck(paycheckId));
    }
